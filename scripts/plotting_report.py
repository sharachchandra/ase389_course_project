...
plt.plot(rel_dis1, label = 'Constant front vehilce velocity')
...
plt.grid()
plt.show()
fig.savefig('data/report/cc0_reward.png')
...
plt.grid()
plt.show()
fig.savefig('data/report/cc0_train.png')